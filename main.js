...
function getPaymentDates(n, startDate) {
  const dates = [];
...
function calculateLoan() {
  ...
  let startDateInput = document.getElementById("loan-start-date").value;

  const initialLoanDate = startDateInput
    ? new Date(startDateInput)
    : new Date(today.getFullYear(), today.getMonth(), 1);

  const loanDates = getPaymentDates(list, initialLoanDate);
...
// // //full version miss table first correct version
// let calcButton = document.getElementById("btn-result");
// let classicBtn = document.getElementById("classic__table-btn");
// let annuityBtn = document.getElementById("annuity__table-btn");
// let annuityContainer = document.getElementById("annuity-table-container");
